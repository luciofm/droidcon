 ...
 *
 */
public class CustomTransitionsCodeFragment extends BaseFragment {
    ...
    public CustomTransitionsCodeFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        text1.setText("Custom Transitions");

        code1 = Html.fromHtml(IOUtils.readFile(getActivity(), "source/custom1.java.html"));
        code2 = Html.fromHtml(IOUtils.readFile(getActivity(), "source/custom2.java.html"));
        code3 = Html.fromHtml(IOUtils.readFile(getActivity(), "source/custom3.java.html"));
        code4 = Html.fromHtml(IOUtils.readFile(getActivity(), "source/custom4.java.html"));
    ...
    private void setupDelayedTransition() {
    ...
    private void setupHideDelayedTransition() {
        TransitionSet set = new TransitionSet();
        set.setOrdering(TransitionSet.ORDERING_SEQUENTIAL);
        Pop pop = new Pop();
        pop.setPropagation(new CircularPropagation() {
